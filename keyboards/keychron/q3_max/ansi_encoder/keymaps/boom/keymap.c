...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_FLEXF4] = ACTION_TAP_DANCE_DOUBLE(KC_F4, KC_F14),
};

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_ansi(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    TD(TD_FLEXF4),  KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,      KC_F12,         KC_MUTE,    KC_PSCR,  WINLOCK,  KC_F13,
    ...
    [WIN_BASE] = LAYOUT_tkl_ansi(
        ...
        KC_CAPS,  KC_A,        KC_S,     KC_D,     KC_F,           KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,                     KC_ENT,
        KC_LSFT,               KC_Z,     KC_X,     KC_C,           KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,                     KC_RSFT,              KC_UP,
        KC_LCTL,  LT(3, KC_LWIN),  KC_LALT,                                      KC_SPC,                                 KC_RALT,  TG(WIN_FN),  TD(TD_WINAPP),  KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),
